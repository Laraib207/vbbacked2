 ...
 * brochure viewer modal and helper sub-components.
 */
        ...
        <div className="w-full flex flex-col gap-1">
          ...
          <div className="w-full flex items-center justify-between px-2 md:px-4">
              ...
              <ul className="flex items-center gap-8 text-xl font-bold">
                ...
                <li className="relative" ref={productsRef}>
                  <button
                    ...
                    onMouseEnter={() => setProductsOpen(true)}
                    onFocus={() => setProductsOpen(true)}
                    className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-white/40"
                  ...
                  >
                    <ul className="py-2">
                      <li><Link href="/products" className="block px-5 py-3 hover:bg-purple-50">All Products</Link></li>
                      <li><Link href="/soyabean-oil" className="block px-5 py-3 hover:bg-purple-50">Soyabean Oil</Link></li>
                      <li><Link href="/mustard-oil" className="block px-5 py-3 hover:bg-purple-50">Mustard Oil</Link></li>
                      <li><Link href="/palm-oil" className="block px-5 py-3 hover:bg-purple-50">Palm Oil</Link></li>
                      <li><Link href="/sunflower-Oil" className="block px-5 py-3 hover:bg-purple-50">Sunflower Oil</Link></li>
                      <li><Link href="/brand-rice" className="block px-5 py-3 hover:bg-purple-50">Brand Rice</Link></li>
                    </ul>
                  </div>
                </li>
                    ...
                    <ul className="py-2">
                      <li>
                        <button
                          ...
                          className="w-full text-left px-5 py-3 hover:bg-purple-50"
                        >
                          View Brochure
                        </button>
                      </li>
                      <li>
                        <a href={pdfPath} download className="block px-5 py-3 hover:bg-purple-50">
                          Download Brochure
                        </a>
                      </li>
                    </ul>
                ...
                <li className="relative" ref={teamRef}>
                  ...
                  >
                    <ul className="py-2">
                      <li><Link href="/team" className="block px-5 py-3 hover:bg-purple-50">Our Team</Link></li>
                      <li><Link href="/gallery" className="block px-5 py-3 hover:bg-purple-50">Gallery</Link></li>
                      <li><Link href="/Managing-Director" className="block px-5 py-3 hover:bg-purple-50">Managing Director</Link></li>
                    </ul>
                  </div>
                </li>
            ...
            <button
              ...
              aria-label="Toggle menu"
            >
              <span className={`block w-7 h-0.5 bg-gradient-to-r from-[#08348b] to-[#aa2266] rounded-full transition-all ${open ? "rotate-45 translate-y-2" : ""}`}/>
              <span className={`block w-7 h-0.5 bg-gradient-to-r from-[#08348b] to-[#aa2266] rounded-full transition-all ${open ? "opacity-0 scale-0" : ""}`}/>
              <span className={`block w-7 h-0.5 bg-gradient-to-r from-[#08348b] to-[#aa2266] rounded-full transition-all ${open ? "-rotate-45 -translate-y-2" : ""}`}/>
            </button>
          </div>

          {/* ---------------------------------------------------------------- */}
          {/* ⭐ COOL WORKING MARQUEE — RESPONSIVE, SMOOTH, NO BUGS ⭐ */}
          {/* ---------------------------------------------------------------- */}

          <div className="w-full overflow-hidden border-t border-[#c7a9ec] relative">
            <div className="marquee-track text-sm sm:text-base font-semibold text-[#08348b]">
              Welcome to Veer Bharat • वाह! मज़ा आ गया • Mustard ,soyabean,palm Oil Special • Welcome to Veer Bharat •
              वाह! मज़ा आ गया • Mustard,soyabean,palm,Oil Special •
            </div>

            {/* INLINE KEYFRAMES (WORKS ON ALL DEVICES) */}
            <style jsx>{`
              .marquee-track {
                white-space: nowrap;
                display: inline-block;
                padding-left: 100%;
                animation: vb-marquee 16s linear infinite;
              }
        ...
        >
          ...
          >
            ...
            <div className="px-6 py-8 flex flex-col gap-3">
              ...
              <details className={`group transition-all duration-700 delay-200 ${open ? "translate-x-0 opacity-100" : "translate-x-8 opacity-0"}`}>
                <summary className="px-5 py-4 cursor-pointer flex justify-between bg-white/70 rounded-xl shadow-md">
                  <span className="flex items-center gap-3 text-[#08348b] font-bold text-lg">
                    <span className="text-2xl">🛍️</span>
                    Products
                  </span>
...
function ChevronIcon({ open }) {
  return (
    <svg
      ...
      fill="none"
    >
      <path d="M5 8l5 5 5-5" stroke="#082f63" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}

function MobileLink({ href, children, icon = "→", onClick = () => {}, delay = "0", isOpen }) {
  return (
    <Link
      href={href}
      onClick={onClick}
      className={`flex items-center gap-3 px-4 py-3 rounded-xl bg-white/60 hover:bg-white transition transform ${
